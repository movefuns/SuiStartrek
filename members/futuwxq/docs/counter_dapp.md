...
export const COUNTER_PACKAGE_ID =
  '0xfc0d9171fb19b1fcb0f6c07ff88a36610d69fa0aceaf3b2b9bb1d91a9676692e'
```

修改`OwnedObjects.tsx`文件，增加显示连接的钱包的 balance
...
创建一个新的`Counter.tsx`，编写 Counter 和 CreateCounter 组件
...
在`App.tsx`文件中添加一个 section，并导入 Counter 和 CreateCounter 组件 并设置 setCounter
