module game::tic_tac_toe {
    // import base on package
    ...
    struct MarkSendEvent has copy, drop {
        game_id: ID,
        mark_id: ID,
    }
    ...
    public entry fun get_status(game: &TicTacToe): u8 {
        game.game_status
    }
